"use strict";exports.id=86,exports.ids=[86],exports.modules={1050:e=>{function t(e,t,u){u=u||2;var d,f,x,v,y,m,P,_=t&&t.length,C=_?t[0]*u:e.length,L=i(e,0,C,u,!0),b=[];if(!L||L.next===L.prev)return b;if(_&&(L=function(e,t,s,l){var c,u,d,f,h,x=[];for(c=0,u=t.length;c<u;c++)d=t[c]*l,f=c<u-1?t[c+1]*l:e.length,(h=i(e,d,f,l,!1))===h.next&&(h.steiner=!0),x.push(function(e){var t=e,i=e;do(t.x<i.x||t.x===i.x&&t.y<i.y)&&(i=t),t=t.next;while(t!==e);return i}(h));for(x.sort(n),c=0;c<x.length;c++)s=function(e,t){var i=function(e,t){var i,o,n,s=t,l=e.x,c=e.y,u=-1/0;do{if(c<=s.y&&c>=s.next.y&&s.next.y!==s.y){var d=s.x+(c-s.y)*(s.next.x-s.x)/(s.next.y-s.y);if(d<=l&&d>u&&(u=d,n=s.x<s.next.x?s:s.next,d===l))return n}s=s.next}while(s!==t);if(!n)return null;var g,f=n,h=n.x,x=n.y,v=1/0;s=n;do l>=s.x&&s.x>=h&&l!==s.x&&r(c<x?l:u,c,h,x,c<x?u:l,c,s.x,s.y)&&(g=Math.abs(c-s.y)/(l-s.x),p(s,e)&&(g<v||g===v&&(s.x>n.x||s.x===n.x&&(i=n,o=s,0>a(i.prev,i,o.prev)&&0>a(o.next,i,i.next))))&&(n=s,v=g)),s=s.next;while(s!==f);return n}(e,t);if(!i)return t;var n=g(i,e);return o(n,n.next),o(i,i.next)}(x[c],s);return s}(e,t,L,u)),e.length>80*u){d=x=e[0],f=v=e[1];for(var S=u;S<C;S+=u)y=e[S],m=e[S+1],y<d&&(d=y),m<f&&(f=m),y>x&&(x=y),m>v&&(v=m);P=0!==(P=Math.max(x-d,v-f))?32767/P:0}return function e(t,i,n,u,d,f,x){if(t){!x&&f&&function(e,t,i,o){var n=e;do 0===n.z&&(n.z=s(n.x,n.y,t,i,o)),n.prevZ=n.prev,n.nextZ=n.next,n=n.next;while(n!==e);n.prevZ.nextZ=null,n.prevZ=null,function(e){var t,i,o,n,s,r,a,l,c=1;do{for(i=e,e=null,s=null,r=0;i;){for(r++,o=i,a=0,t=0;t<c&&(a++,o=o.nextZ);t++);for(l=c;a>0||l>0&&o;)0!==a&&(0===l||!o||i.z<=o.z)?(n=i,i=i.nextZ,a--):(n=o,o=o.nextZ,l--),s?s.nextZ=n:e=n,n.prevZ=s,s=n;i=o}s.nextZ=null,c*=2}while(r>1)}(n)}(t,u,d,f);for(var v,y,m=t;t.prev!==t.next;){if(v=t.prev,y=t.next,f?function(e,t,i,o){var n=e.prev,l=e.next;if(a(n,e,l)>=0)return!1;for(var c=n.x,u=e.x,d=l.x,p=n.y,g=e.y,f=l.y,h=c<u?c<d?c:d:u<d?u:d,x=p<g?p<f?p:f:g<f?g:f,v=c>u?c>d?c:d:u>d?u:d,y=p>g?p>f?p:f:g>f?g:f,m=s(h,x,t,i,o),P=s(v,y,t,i,o),_=e.prevZ,C=e.nextZ;_&&_.z>=m&&C&&C.z<=P;){if(_.x>=h&&_.x<=v&&_.y>=x&&_.y<=y&&_!==n&&_!==l&&r(c,p,u,g,d,f,_.x,_.y)&&a(_.prev,_,_.next)>=0||(_=_.prevZ,C.x>=h&&C.x<=v&&C.y>=x&&C.y<=y&&C!==n&&C!==l&&r(c,p,u,g,d,f,C.x,C.y)&&a(C.prev,C,C.next)>=0))return!1;C=C.nextZ}for(;_&&_.z>=m;){if(_.x>=h&&_.x<=v&&_.y>=x&&_.y<=y&&_!==n&&_!==l&&r(c,p,u,g,d,f,_.x,_.y)&&a(_.prev,_,_.next)>=0)return!1;_=_.prevZ}for(;C&&C.z<=P;){if(C.x>=h&&C.x<=v&&C.y>=x&&C.y<=y&&C!==n&&C!==l&&r(c,p,u,g,d,f,C.x,C.y)&&a(C.prev,C,C.next)>=0)return!1;C=C.nextZ}return!0}(t,u,d,f):function(e){var t=e.prev,i=e.next;if(a(t,e,i)>=0)return!1;for(var o=t.x,n=e.x,s=i.x,l=t.y,c=e.y,u=i.y,d=o<n?o<s?o:s:n<s?n:s,p=l<c?l<u?l:u:c<u?c:u,g=o>n?o>s?o:s:n>s?n:s,f=l>c?l>u?l:u:c>u?c:u,h=i.next;h!==t;){if(h.x>=d&&h.x<=g&&h.y>=p&&h.y<=f&&r(o,l,n,c,s,u,h.x,h.y)&&a(h.prev,h,h.next)>=0)return!1;h=h.next}return!0}(t)){i.push(v.i/n|0),i.push(t.i/n|0),i.push(y.i/n|0),h(t),t=y.next,m=y.next;continue}if((t=y)===m){x?1===x?e(t=function(e,t,i){var n=e;do{var s=n.prev,r=n.next.next;!l(s,r)&&c(s,n,n.next,r)&&p(s,r)&&p(r,s)&&(t.push(s.i/i|0),t.push(n.i/i|0),t.push(r.i/i|0),h(n),h(n.next),n=e=r),n=n.next}while(n!==e);return o(n)}(o(t),i,n),i,n,u,d,f,2):2===x&&function(t,i,n,s,r,u){var d=t;do{for(var f,h,x=d.next.next;x!==d.prev;){if(d.i!==x.i&&(f=d,h=x,f.next.i!==h.i&&f.prev.i!==h.i&&!function(e,t){var i=e;do{if(i.i!==e.i&&i.next.i!==e.i&&i.i!==t.i&&i.next.i!==t.i&&c(i,i.next,e,t))return!0;i=i.next}while(i!==e);return!1}(f,h)&&(p(f,h)&&p(h,f)&&function(e,t){var i=e,o=!1,n=(e.x+t.x)/2,s=(e.y+t.y)/2;do i.y>s!=i.next.y>s&&i.next.y!==i.y&&n<(i.next.x-i.x)*(s-i.y)/(i.next.y-i.y)+i.x&&(o=!o),i=i.next;while(i!==e);return o}(f,h)&&(a(f.prev,f,h.prev)||a(f,h.prev,h))||l(f,h)&&a(f.prev,f,f.next)>0&&a(h.prev,h,h.next)>0))){var v=g(d,x);d=o(d,d.next),v=o(v,v.next),e(d,i,n,s,r,u,0),e(v,i,n,s,r,u,0);return}x=x.next}d=d.next}while(d!==t)}(t,i,n,u,d,f):e(o(t),i,n,u,d,f,1);break}}}}(L,b,u,d,f,P,0),b}function i(e,t,i,o,n){var s,r;if(n===v(e,t,i,o)>0)for(s=t;s<i;s+=o)r=f(s,e[s],e[s+1],r);else for(s=i-o;s>=t;s-=o)r=f(s,e[s],e[s+1],r);return r&&l(r,r.next)&&(h(r),r=r.next),r}function o(e,t){if(!e)return e;t||(t=e);var i,o=e;do if(i=!1,!o.steiner&&(l(o,o.next)||0===a(o.prev,o,o.next))){if(h(o),(o=t=o.prev)===o.next)break;i=!0}else o=o.next;while(i||o!==t);return t}function n(e,t){return e.x-t.x}function s(e,t,i,o,n){return(e=((e=((e=((e=((e=(e-i)*n|0)|e<<8)&0xff00ff)|e<<4)&0xf0f0f0f)|e<<2)&0x33333333)|e<<1)&0x55555555)|(t=((t=((t=((t=((t=(t-o)*n|0)|t<<8)&0xff00ff)|t<<4)&0xf0f0f0f)|t<<2)&0x33333333)|t<<1)&0x55555555)<<1}function r(e,t,i,o,n,s,r,a){return(n-r)*(t-a)>=(e-r)*(s-a)&&(e-r)*(o-a)>=(i-r)*(t-a)&&(i-r)*(s-a)>=(n-r)*(o-a)}function a(e,t,i){return(t.y-e.y)*(i.x-t.x)-(t.x-e.x)*(i.y-t.y)}function l(e,t){return e.x===t.x&&e.y===t.y}function c(e,t,i,o){var n=d(a(e,t,i)),s=d(a(e,t,o)),r=d(a(i,o,e)),l=d(a(i,o,t));return!!(n!==s&&r!==l||0===n&&u(e,i,t)||0===s&&u(e,o,t)||0===r&&u(i,e,o)||0===l&&u(i,t,o))}function u(e,t,i){return t.x<=Math.max(e.x,i.x)&&t.x>=Math.min(e.x,i.x)&&t.y<=Math.max(e.y,i.y)&&t.y>=Math.min(e.y,i.y)}function d(e){return e>0?1:e<0?-1:0}function p(e,t){return 0>a(e.prev,e,e.next)?a(e,t,e.next)>=0&&a(e,e.prev,t)>=0:0>a(e,t,e.prev)||0>a(e,e.next,t)}function g(e,t){var i=new x(e.i,e.x,e.y),o=new x(t.i,t.x,t.y),n=e.next,s=t.prev;return e.next=t,t.prev=e,i.next=n,n.prev=i,o.next=i,i.prev=o,s.next=o,o.prev=s,o}function f(e,t,i,o){var n=new x(e,t,i);return o?(n.next=o.next,n.prev=o,o.next.prev=n,o.next=n):(n.prev=n,n.next=n),n}function h(e){e.next.prev=e.prev,e.prev.next=e.next,e.prevZ&&(e.prevZ.nextZ=e.nextZ),e.nextZ&&(e.nextZ.prevZ=e.prevZ)}function x(e,t,i){this.i=e,this.x=t,this.y=i,this.prev=null,this.next=null,this.z=0,this.prevZ=null,this.nextZ=null,this.steiner=!1}function v(e,t,i,o){for(var n=0,s=t,r=i-o;s<i;s+=o)n+=(e[r]-e[s])*(e[s+1]+e[r+1]),r=s;return n}e.exports=t,e.exports.default=t,t.deviation=function(e,t,i,o){var n=t&&t.length,s=n?t[0]*i:e.length,r=Math.abs(v(e,0,s,i));if(n)for(var a=0,l=t.length;a<l;a++){var c=t[a]*i,u=a<l-1?t[a+1]*i:e.length;r-=Math.abs(v(e,c,u,i))}var d=0;for(a=0;a<o.length;a+=3){var p=o[a]*i,g=o[a+1]*i,f=o[a+2]*i;d+=Math.abs((e[p]-e[f])*(e[g+1]-e[p+1])-(e[p]-e[g])*(e[f+1]-e[p+1]))}return 0===r&&0===d?0:Math.abs((d-r)/r)},t.flatten=function(e){for(var t=e[0][0].length,i={vertices:[],holes:[],dimensions:t},o=0,n=0;n<e.length;n++){for(var s=0;s<e[n].length;s++)for(var r=0;r<t;r++)i.vertices.push(e[n][s][r]);n>0&&(o+=e[n-1].length,i.holes.push(o))}return i}},3154:(e,t,i)=>{i.d(t,{A:()=>h});var o=i(8985),n=i(7826),s=i(1110),r=i(8131),a=i(9737);let l=`\
uniform arcUniforms {
  bool greatCircle;
...
`,h={name:"column",vs:f,fs:f,uniformTypes:{radius:"f32",angle:"f32",offset:"vec2<f32>",extruded:"f32",stroked:"f32",isStroke:"f32",coverage:"f32",elevationScale:"f32",edgeDistance:"f32",widthScale:"f32",widthMinPixels:"f32",widthMaxPixels:"f32",radiusUnits:"i32",widthUnits:"i32"}},x=`#version 300 es
